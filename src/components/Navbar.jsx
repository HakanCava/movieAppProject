...
const Navbar = () => {
  ...
  return (
    <div>
      <nav
        className="flex w-full flex-wrap items-center justify-between bg-black text-white dark:bg-black py-3 dark:text-neutral-200 shadow-lg lg:flex-wrap lg:justify-start fixed top-0 z-20"
        data-te-navbar-ref=""
      >
        <div className="flex w-full flex-wrap items-center justify-between px-6">
          <Link className="text-2xl font-semibold" to="/">React Movie App</Link>
